...
class opts():
    ...
    def init(self):
        self.parser.add_argument('--model', default='PoseGRAF_17_4813', type=str)
        ...
        self.parser.add_argument('--batch_size', type=int, default=11, help='can be changed depending on your machine') # default 128
        ...
        self.parser.add_argument('--previous_dir', type=str, default='./pre_trained_model/PoseGRAF_17_4813')
