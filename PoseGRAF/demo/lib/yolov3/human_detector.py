...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= 'E:/ESSAY/Pose_Estimate_3D/Essay_referenceAndcode/IGANet-main/demo/lib/checkpoint/yolov3.weights', help='The path'
...
def yolo_human_det(img, model=None, reso=416, confidence=0.70):
    ...
    print('human_detector_img',img,inp_dim)
